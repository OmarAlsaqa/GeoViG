...
parser.add_argument('--geovig_model', default='geovig_m', type=str, metavar='MODEL',
                help='Name of model to train (default: "geovig_m"')
parser.add_argument(
...
print(args)
print("\n geovig_model = " + str(args.geovig_model))
